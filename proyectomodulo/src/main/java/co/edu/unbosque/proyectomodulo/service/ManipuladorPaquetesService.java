 ...
 * {@link ManipuladorPaquete}. Permite la creación, actualización, eliminación y
 * consulta de manipuladores, así como el manejo de sesión.
 *
 * @version 1.0
 */
@Service
public class ManipuladorPaquetesService implements CRUDOPERATION<ManipuladorPaqueteDTO> {
	...
	/**
	 * Crea un nuevo manipulador de paquetes. Requiere autenticación de
	 * administrador, validación de horas de trabajo y que el usuario no exista
	 * previamente.
	 *
	 * @param data datos del manipulador
	 * @return {@code 0} creado, {@code 1} error de validación o usuario existente,
	 *         {@code 2} sin permisos
	 */
	@Override
	...
	/**
	 * Obtiene todos los manipuladores registrados. Requiere autenticación de
	 * administrador.
	 *
	...
	public String getAll() {
		...
		entityList.forEach(entity -> dtoList.add(mapper.map(entity, ManipuladorPaqueteDTO.class)));

		return gson.toJson(dtoList);
	}

	/**
	 * Elimina un manipulador por su ID. Requiere autenticación de administrador.
	 *
	...
	/**
	 * Actualiza un manipulador existente. Requiere autenticación de administrador y
