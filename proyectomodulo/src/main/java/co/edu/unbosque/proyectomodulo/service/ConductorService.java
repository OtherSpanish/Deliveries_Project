 ...
 * para la entidad {@link Conductor}. Permite la creación,
 * actualización, eliminación y consulta de conductores,
...
public class ConductorService implements CRUDOPERATION<ConductorDTO> {
     ...
     * Requiere autenticación de administrador y validación del tipo de vehículo.
     *
     * @param data datos del conductor
     * @return {@code 0} creado,
     *         {@code 1} tipo de vehículo inválido,
     *         {@code 2} sin permisos,
     *         {@code 3} usuario existente
     */
    @Override
