...
public class Paquete {
	...
	/**
	 * Constructor por defecto de {@code Paquete}.
	 */
	public Paquete() {
		super();
	}
	...
	/**
	 * Constructor completo con todos los atributos del paquete.
	 *
	...
	/**
	 * Retorna el precio de envío del paquete.
	 *
	...
	/**
	 * Retorna una representación en cadena del objeto {@code Paquete},
	 * incluyendo todos sus campos.
	 *
	 * @return cadena con los valores de los atributos de la entidad.
	 */
	@Override
	 ...
	 *
	 * @return código hash del {@code Paquete}.
	 */
	@Override
	public int hashCode() {
	 ...
	 * de {@code Paquete} son iguales si todos sus campos tienen el mismo valor.
